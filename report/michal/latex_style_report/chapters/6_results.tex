...
\section{Perturbative analysis of selection rules} \label{sec:symmetry_suppression}
Suppose now we have a system described by a Hamiltonian $\hat{H}$ equipped with a group of symmetries $G$. Let us construct a Hamiltonian $\hat{H}_+$ which is equipped with a group of symmetries $G_+$ such that $G\subset G_+$ and $\hat{H}$ can be modelled as a perturbation of $\hat{H}_+$ like so:
	...
	\subsection{Elevated symmetry component of an energy eigenstate}
	...
	\end{align}
	\subsection{Selection rules for the elevated symmetry component}
...
\section{Localisation of heavy-hole excitons in the bulk} \label{sec:localisation}
...
\section{Identifying intermediate groups of bulk and structure symmetries}
...
\section{Predictions and their agreement with experiments}
...
\subsection{Fermion transformation properties in different groups}
...
\subsection{Number of lines for exciton and biexciton decays} \label{sec:testing_against_data}
